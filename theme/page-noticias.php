...
<div class="w-full max-w-[1350px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] gap-y-5 gap-x-5 justify-items-center mt-8 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
      ...
      <div class="mt-5 grid grid-cols-1 md:grid-cols-[1fr_300px] gap-5">
        <div class="flex flex-col gap-y-5">
          <a href="">
            <article class="w-full lg:h-[250px]">
              <div class="w-full h-max grid lg:grid-cols-[300px_1fr]">
                ...
                <div class="rounded-bl-lg rounded-br-lg lg:rounded-tr-lg lg:rounded-br-lg border w-full flex flex-col justify-between py-4 px-2 lg:px-4">
                  <div>
                    <span class="rounded-lg inline-block w-fit py-1 px-2 bg-blue-50 text-blue-100 text-xs-b">Farándula</span>
          ...
          <a href="">
            <article class="w-full lg:h-[250px]">
              <div class="w-full h-max grid lg:grid-cols-[300px_1fr]">
                <div class="rounded-tl-lg rounded-bl-lg border w-full flex flex-col justify-between py-4 px-2 lg:px-4 order-1">
                  <div>
                    <span class="rounded-lg inline-block w-fit py-1 px-2 bg-blue-50 text-blue-100 text-xs-b">Farándula</span>
                    <p class="mt-2 text-body-b lg:text-m-b text-blueLight-900">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
                  </div>
                ...
                <div class="relative lg:order-2">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/img-01.png" alt="" class="rounded-tr-lg rounded-br-lg w-full min-h-[256px] max-h-[300px] object-cover">
                  <div class="absolute top-5 right-5 z-10">
                    <span class="rounded-full w-8 h-8 flex items-center justify-center bg-blue-50">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-2 fill-[#D9D9D9]" viewBox="0 0 384 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80L0 432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z" />
        ...
        <div>
          <div class="w-full lg:h-[250px] p-3 bg-[#F1F3F7]">
            <div class="w-full h-full bg-[#D6CCFF]"></div>
          </div>

          <div class="w-full lg:h-[250px] mt-8 p-3 bg-[#F1F3F7]">
            <div class="w-full h-full bg-[#D6CCFF]"></div>
          </div>
              ...
              <article class="rounded-md border w-full grid grid-cols-[60%_40%] overflow-hidden min-h-[140px] max-h-[140px]">
                <div class="content">
                  <div class="w-full p-2">
                    <span class="text-blue-50 text-xs-b">Farándula</span>
                    <p class="lg:w-[16ch] mt-2 text-body-b text-blueLight-900">Son una forma emocionante de poner a prueba el cuerpo y la mente</p>
                  </div>
                </div>
                <div class="image w-40%" style="overflow: hidden; position: relative">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-5 mt-10">
      <div class="w-max">
