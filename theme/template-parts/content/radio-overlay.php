<div id="radio-overlay" class="hidden w-full absolute top-0 bg-white z-50">
  <div class="py-24 px-12 <?php echo is_user_logged_in() ? 'pt-16' : 'top-0' ?>">
    ...
    <div class="w-full mt-10 grid md:grid-cols-[1fr_322px] gap-5">
      <div>
        <div class="relative h-[460px]">
          <img src="<?php echo get_template_directory_uri(); ?>/images/img-05.png" alt="" class="rounded-lg block w-full h-[460px] object-cover">
        ...
        <div class="w-full max-w-[994px] h-[274px] mx-auto mt-3 p-3 bg-[#F1F3F7]">
          <div class="w-full h-full bg-[#D6CCFF]">
          </div>
        </div>
      </div>
      <div class="rounded-lg w-full h-[750px] p-2 bg-blue-50">
        ...
        <div class="rounded-lg w-full h-[668px] mt-2 bg-white overflow-auto">
          <p class="border-b border-[#DDDDDD] p-2 text-s">
            <span class="font-bold">Athena: </span>
        ...
        <div class="mt-2 flex flex-row items-center gap-3">
          <div class="rounded-full w-[20px] h-[20px] bg-[#FFFFFF]"></div>
          <span class="rounded-full w-[20px] h-[20px] bg-[#FFFFFF]"></span>
          <input type="text" placeholder="Escribe tu mensaje" class="rounded w-full max-w-[177px] px-2 py-1.5">
          <span class="rounded-full w-[20px] h-[20px] bg-[#FFFFFF]"></span>
          <span class="rounded-full w-[20px] h-[20px] bg-[#FFFFFF]"></span>
        </div>
      </div>
