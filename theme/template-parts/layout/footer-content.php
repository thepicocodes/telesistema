		...
		<div class="py-9 flex flex-col lg:flex-row items-center justify-between gap-y-5 text-white">
			...
			<div>
				<ul class="mt-10 md:mt-0 flex flex-wrap items-center gap-y-12 gap-x-12 lg:gap-x-4 lg:gap-y-2.5">
					...
					<li>
						<a href="">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-8 fill-white" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
