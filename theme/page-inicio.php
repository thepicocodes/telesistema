...
<div class="mx-auto mt-8 grid w-full max-w-[1360px] grid-cols-1 justify-items-center gap-[23px] px-5 lg:px-0 xl:grid-cols-[160px_1fr_160px]">
	...
	<div class="order-2 w-full">
			...
			<div class="mt-5 grid grid-cols-1 gap-5 md:grid-cols-[1fr_300px]">
				...
				<div class="mt-4 grid gap-x-2 gap-y-4 md:mt-0">
					<a href="/" class="mid-block">
						<article class="grid h-[140px] w-full grid-cols-[60%_40%] overflow-hidden rounded-md border">
							<div class="content">
								<div class="w-full px-2 py-4">
									<p class="text-body-b text-blueLight-900 mt-2 lg:w-[16ch]">Son una forma emocionante de poner a prueba el cuerpo y la mente</p>
								</div>
							</div>
							<div class="image w-40%" style="overflow: hidden; position: relative">
								<div class="h-full">
									<img src="<?php echo get_template_directory_uri(); ?>/images/img-02.png" alt="" class="h-full w-full object-cover">
								</div>
							</div>
						</article>
					</a>
		...
		<section class="mx-auto mt-10 max-w-[960px]">
			<div class="">
				<div class="mb-4 flex items-center justify-between">
					<h2 class="lg:text-h5 text-blue-telesistema text-lg">Información y Opinión</h2>
				...
				<div class="swiper mySwiper">
					...
					<div class="swiper-button-next !top-[30%] !h-[60px] !w-[60px] !rounded-full !bg-blue-100">
						<svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-telesistema !h-5" viewBox="0 0 320 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" />
						</svg>
					</div>
					<div class="swiper-button-prev !top-[30%] !h-[60px] !w-[60px] !rounded-full !bg-blue-100">
						<svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-telesistema !h-5" viewBox="0 0 320 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
		...
		<section class="mx-auto mt-10 max-w-[960px]">
			<div class="">
				<div class="mb-4 flex items-center justify-between">
					<h2 class="lg:text-h5 text-blue-telesistema text-lg">Avances de novelas</h2>
					<a href="#" class="text-m-b flex items-center gap-x-2 text-blue-50">
						Ver más
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-blue-50" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
		...
		<section class="mx-auto mt-10 max-w-[960px]">
			<div class="">
				<div class="mb-4 flex items-center justify-between">
					<h2 class="lg:text-h5 text-blue-telesistema text-lg">Variedades</h2>
					<a href="#" class="text-m-b flex items-center gap-x-2 text-blue-50">
						Ver más
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-blue-50" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
		...
		<section class="mx-auto mt-10 max-w-[960px]">
			<div class="">
				<div class="mb-4 flex items-center justify-between">
					<h2 class="lg:text-h5 text-blue-telesistema text-lg">Infantiles</h2>
					<a href="#" class="text-m-b flex items-center gap-x-2 text-blue-50">
						Ver más
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-blue-50" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
		...
		<section class="mx-auto mt-10 max-w-[960px]">
			<div class="">
				<div class="mb-4 flex items-center justify-between">
					<h2 class="lg:text-h5 text-blue-telesistema text-lg">Episodios anteriores</h2>
					<a href="#" class="text-m-b flex items-center gap-x-2 text-blue-50">
						Ver más
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-blue-50" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
		...
		<section class="mx-auto mt-10 max-w-[960px]">
			...
			<div class="mt-6 grid gap-x-5 gap-y-5 md:grid-cols-2 lg:grid-cols-3">
				<div class="mt-4 grid gap-x-2 gap-y-4 md:mt-0">
					<a href="/" class="mid-block">
						<article class="grid w-full grid-cols-[60%_40%] rounded-md border border-gray-100" style="overflow: hidden; height: 140px;">
							<div class="content">
								<div class="w-full px-2 py-4">
									<p class="text-body-b text-blueLight-900 mt-2 lg:w-[16ch]">Son una forma emocionante de poner a prueba el cuerpo y la mente</p>
								</div>
							...
							<div class="image w-40%" style="overflow: hidden; position: relative">
								<div class="h-full">
									<img src="<?php echo get_template_directory_uri(); ?>/images/img-02.png" alt="" class="object-fit h-full w-full" style="object-fit: cover">
								</div>
							</div>
						</article>
					</a>
		...
		<section class="mx-auto mt-10 grid w-full max-w-[994px] grid-cols-1 gap-x-6 gap-y-16 lg:grid-cols-[650px_323px]">
			<div>
				<h3 class="lg:text-h5 text-blue-telesistema text-lg">Programación</h3>
				...
				<a href="#" class="text-m-b text-orange-laNota mt-4 flex flex-row items-center justify-center gap-x-1">
					Ver más
					<span>
						<svg xmlns="http://www.w3.org/2000/svg" class="fill-orange-laNota h-4" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
						</svg>
					</span>
				</a>
