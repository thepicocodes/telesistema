...
<div class="w-full max-w-[1350px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] gap-y-5 gap-x-5 justify-items-center mt-8 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <section class="shadow-md rounded-lg border grid lg:grid-cols-[500px_1fr] gap-6 p-6">
      ...
      <div>
        <h5 class="text-h5 text-lightBlue-900">Telenoticias estelar</h5>
        <p class="mt-2 text-m">
        ...
        <div class="swiper mySwiper mt-10">
          <div class="swiper-wrapper">
            <div class="swiper-slide !h-[300px] bg-white rounded-lg shadow-lg overflow-hidden">
              <a href="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/img-10.png" alt="Slide 1" class="relative w-full !h-full">
              </a>
            </div>
